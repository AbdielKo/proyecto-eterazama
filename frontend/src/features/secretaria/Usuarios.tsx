...
import { asignarRolChofer } from "../../api/secretaria.api";
import { useFlotaSocket } from "../../hooks/useFlotaSocket";
import { Search, Users, UserCheck, UserX, ChevronDown, ChevronUp } from "lucide-react";
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-0.5">
            Gestiona los usuarios. La secretaria solo puede asignar el rol de chofer.
          </p>
        </div>
      </div>
